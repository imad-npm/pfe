...
<div class="group mb-3 border-b-2 pb-5">
 <h3 class="text-xl mb-1  font-semibold"> Student 1 : </h3>
    ...
    <div> <span class=" font-semibold me-2"> Full Name </span>{{$team->student1->fullName}} </div>
        <div> <span class=" font-semibold me-2 "> Email </span> {{$team->student1_email}}  </div>
  </div>

    @if ($team->student2)
  <div class="group mb-3 border-b-2 pb-5">
    <h3 class="text-xl font-semibold mb-1"> Student 2 : </h3>
    <div> <span class=" font-semibold me-2"> Full Name </span>{{$team->student2->fullName }} </div>
    <div> <span class=" font-semibold me-2 "> Email </span> {{$team->student2_email}}  </div>
</div>
 @endif
...
<div class="group flex items-baseline mb-3  ">
    ...
    <span class="text-xl font-semibold me-2 "> Speciality :</span>  
     <span class="py-0.5 px-2 text-md rounded-md bg-blue-100 
     font-semibold text-primary border border-gray-300  uppercase"> {{$team->speciality}}</span>
...
<div class="group flex items-baseline mb-3  ">
    ...
    <span class="text-xl font-semibold me-2 ">  Choice Status :</span>  
     ...
     'bg-green-001 text-success' : 'bg-red-100 text-danger'}}"
