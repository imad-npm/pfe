...
<div class="w-[90%] bg-white mt-10 md:w-1/2 mx-auto  rounded-lg border 
 shadow-lg shadow-gray- p-5 md:p-7">
   ...
   <div>
   <div class="text-3xl font-semibold"> {{$teacher->firstname.' '.$teacher->lastname}}
</div>
    ...
    <div class=" ">
        ...
        <p class="w-2/3">    {{$teacher->institution}}</p> 
            ...
            <div class="py-5 border-t-2">
                <a class="text-primary underline" href="{{route('subjects.index'
